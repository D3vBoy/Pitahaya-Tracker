            ...
            {loading ? (
              ...
              data.map((prospect) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">{prospect.estatus_general || "-"}</td>
                  <td className="px-4 py-3">{prospect.estatus_enganche || "-"}</td>
                  ...
                  <td className="px-4 py-3">{prospect.metros_cuadrados_tentativos ?? "-"}</td>
                  <td className="px-4 py-3">{prospect.plan_financiamiento || "-"}</td>
                  ...
                  <td className="max-w-72 truncate px-4 py-3">{prospect.proxima_accion || "-"}</td>
                  <td className="px-4 py-3">{formatFecha(prospect.proximo_seguimiento)}</td>
                  <td className="max-w-96 truncate px-4 py-3">{prospect.observaciones || "-"}</td>
                </tr>
              ))
            )}
          </tbody>
